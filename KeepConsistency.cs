...
public class KeepConsistency {
  ...
  private static void PrepareImagePaths() {
    SearchDirectory = Path.Combine(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyPictures), "SaveWindowsWallpaper"), "Temporary");
